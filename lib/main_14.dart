    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          backgroundColor: Color.fromARGB(255, 255, 0, 0), // Cor de fundo
          iconTheme: IconThemeData(
            color: Colors.white, // Muda a cor do ícone do menu hamburger
          ),
        ),
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              ListTile(
                ...
                title: Text('Sensor Registration'),
                onTap: () {
                  Navigator.pop(context); // Fecha o drawer
                },
              ),
